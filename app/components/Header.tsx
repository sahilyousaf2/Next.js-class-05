...
const Header = () => {
  ...
  return (
    <>
      <header className='mt-3 backdrop-blur sticky top-0 sx:hidden'>
        <nav className="max-w-[1170px] mx-auto">
          <div className="main flex justify-between items-center h-14">
            <div className="logo">
              <Link href={"/"}><h1 className='text-3xl hover:scale-110 duration-300 hover:text-[#01AECD] font-bold'>Sahil Yousaf</h1></Link>
            </div>
            {/* list */}
